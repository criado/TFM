...
class prismatoid { public:
  ...
  int permutation[2*N];            // One symmetry that we want to preserve.
  int asymmetries;
  //////////////////////////////////////////////////////////////////////////////
  // Public methods
  //////////////////////////////////////////////////////////////////////////////
  ...
  int symmetriesOf(mask f);         // How many symmetric facets.
  int computeAsymmetries();
};
